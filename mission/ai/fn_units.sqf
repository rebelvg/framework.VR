...
//Infantry
_grp = [getMarkerPos "mission_spawn", "EAST", _unitCount, _skillName] call kf_fnc_ai_createGroup;
...
_grp = [getMarkerPos "mission_spawn", "EAST", _radius, _unitCount, _skillName, _threshold, ["DOWN", "MIDDLE", "UP", "AUTO"]] call kf_fnc_ai_infantryBunker;

//Vehicles
_veh = [getMarkerPos "mission_spawn", "EAST Crew", "EAST Car", _skillName] call kf_fnc_ai_createVehicleGroup;
[_veh, getMarkerPos "mission_attack", _radius] call kf_fnc_ai_vehicleAttack;

//Air Vehicles
_veh = [getMarkerPos "mission_spawn", "EAST Crew", "EAST Air", _skillName, _flyHeight] call kf_fnc_ai_createAirVehicleGroup;
