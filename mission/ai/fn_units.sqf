...
[getMarkerPos "SPAWNMARKERNAME", getMarkerPos "ATTACKMARKERNAME", "EAST", EAST] call mf_fnc_ai_infantryAttack;
[getMarkerPos "SPAWNMARKERNAME", getMarkerPos "ATTACKMARKERNAME", "EAST", EAST] call mf_fnc_ai_infantryDefend;
[getMarkerPos "SPAWNMARKERNAME", getMarkerPos "ATTACKMARKERNAME", "EAST", EAST] call mf_fnc_ai_infantryPatrol;
[getMarkerPos "SPAWNMARKERNAME", getMarkerPos "ATTACKMARKERNAME", "EAST Crew", "EAST Car", EAST] call mf_fnc_ai_vehicleAttack;
[getMarkerPos "SPAWNMARKERNAME", getMarkerPos "ATTACKMARKERNAME", "EAST Crew", "EAST Air", EAST] call mf_fnc_ai_airPatrol;
...
mf_fnc_ai_soldierArray = {
    ...
    case "RESISTANCE": { ["I_Soldier_SL_F","I_soldier_AR_F","I_soldier_exp_F","I_soldier_GL_F","I_soldier_AA_F","I_soldier_M_F","I_medic_F","I_soldier_repair_F","I_Soldier_F","I_soldier_LAT_F","I_soldier_lite_F","I_soldier_TL_F"] };
        //crew, pilot
    case "EAST Crew": { ["O_crew_F","O_Helipilot_F"] };
    case "WEST Crew": { ["B_crew_F","B_Helipilot_F"] };
    case "RESISTANCE Crew": { ["I_crew_F","I_Helipilot_F"] };
        default { [] };
    };
